...
namespace Moonlight
{
	...
	public class ModSettings_Moonlight : ModSettings
	{
		...
		{
			Scribe_Values.Look<float>(ref darkest, "darkest", 0.35f, false);
            Scribe_Values.Look<float>(ref brightest, "brightest", 1f, false);
			base.ExposeData();
		}

		public static float darkest = 0.35f;
        public static float brightest = 1f;
